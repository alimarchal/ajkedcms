<x-app-layout>
    ...
    <x-slot name="header">
        ...
        <div class="flex justify-center items-center float-right">
            <a href="#" class="flex items-center px-4 py-2 text-gray-600 bg-white border rounded-lg
            ...
            <div class="bg-white overflow-hidden shadow-xl sm:rounded-lg">
                <div class="p-6 sm:px-10 bg-white border-b border-gray-200">
                    <div class="mt-6 text-gray-500">
                        ...
                        <form action="{{route('user.update',$user->id)}}" class="mb-6" method="post">
                            @csrf
                            @method('PUT')
                            <div class="bg-white rounded px-8 pt-6 pb-8 ">
                                ...
                                <div class="-mx-3 md:flex mb-3">
                                    <div class="w-full px-3" row="8">
                                        ...
                                        <input type="text" name="name" value="{{$user->name}}" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4">
                                    </div>
                                </div>
                                ...
                                <div class="-mx-3 md:flex mb-3">
                                    <div class="w-full px-3">
                                        ...
                                        <input value="{{$user->email}}"  class="border-gray-300 focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50 rounded-md shadow-sm block mt-1 w-full" id="email" type="email" name="email" required="required">
                                    </div>
                                </div>
                                ...
                                <div class="-mx-3 md:flex mb-3">
                                    <div class="w-full px-3" row="8">
                                        ...
                                        <input type="text" value="{{$user->designation}}" name="designation" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4">
                                    </div>
                                </div>
                                ...
                                <div class="-mx-3 md:flex mb-3">
                                    <div class="w-full px-3" row="8">
                                        ...
                                        <input type="text" value="{{$user->contact}}" name="contact" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-grey-lighter rounded py-3 px-4">
                                    </div>
                                </div>
                                    ...
                                    <div class="w-full px-3">
                                        ...
                                        <select name="office" id="office" class="appearance-none block w-full bg-grey-lighter text-grey-darker border border-red rounded py-3 px-4 mb-3">
                                            ...
                                            @foreach(\App\Models\User::office() as $ofc)
                                                <option value="{{$ofc}}" @if($user->office == $ofc) selected @endif>{{$ofc}}</option>
                                            @endforeach
                                        </select>
                                    </div>
                                </div>
